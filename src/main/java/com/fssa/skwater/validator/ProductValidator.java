...
public class ProductValidator {
	 ...
	 * @return True if validation passes.
	 * @throws IllegalArgumentException If the product ID is less than or equal to
	 *                                  0.
	 */
	...
	/**
	 * Validates the product name to ensure it's not null, empty, and matches a
	 * specific pattern.
	 *
	 * @param productName The product name to validate.
	 * @return True if validation passes.
	 * @throws IllegalArgumentException If the product name is null, empty, or
...
// regex pattern for product name
	...
	/**
	 * Validates the product image URL to ensure it's not null and matches a
	 * specific pattern.
	 *
	 * @param string The product image URL to validate.
	 * @return True if validation passes.
	 * @throws IllegalArgumentException If the product image URL is null or doesn't
	 *                                  match the pattern.
	 * 
	 *                                  Regular expression pattern for validating a
	 *                                  URL that points to an image. // Regular
	 *                                  expression pattern for validating a URL that
	 *                                  points to an image. Explanation of the
	 *                                  pattern components: (?i) : Enable
	 *                                  case-insensitive matching. \\b : Match a
	 *                                  word boundary. ((https?|ftp)://)? : Optional
	 *                                  scheme prefix "http://", "https://", or
	 *                                  "ftp://". [a-z0-9-]+ : Match lowercase
	 *                                  letters, digits, and hyphens in the domain
	 *                                  name. (\\.[a-z0-9-]+)+ : Match one or more
	 *                                  subdomains separated by dots. ([/?].*)? :
	 *                                  Optional path and query parameters.
	 *                                  \\.(jpg|jpeg|gif|png|bmp) : Match supported
	 *                                  image file extensions. \\b : Match another
	 *                                  word boundary.
	 */
